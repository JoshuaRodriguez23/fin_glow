...
class StoreScreenState extends State<StoreScreen> {
  ...
  late Future<StoreViewData> storeViewData;
  late List<Widget> _views;

  @override
  void initState() {
    super.initState();
    storeViewData = StoreViewRepository().fetchStoreViewData();
  }

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<StoreViewData>(
      future: storeViewData,
                      ...
                      Column(
                        children: [
                          CarouselSlider(
                            ...
                            items: data.promotions.map((promotion) {
                              return Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color:
                                          const Color.fromARGB(76, 16, 57, 121),
